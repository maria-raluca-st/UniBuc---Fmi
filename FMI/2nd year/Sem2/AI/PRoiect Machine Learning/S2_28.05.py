...
CV = CountVectorizer(lowercase = False, stop_words = None,ngram_range=(1,2),tokenizer = my_tokenizer)
#,token_pattern = '[a-zA-Z0-9$&+,:;=?@#|<>.^*()%!-]+'

#CV = TfidfVectorizer(lowercase = False, stop_words = None, ngram_range=(1,2),tokenizer=my_tokenizer)
...
#LR1 = LogisticRegressionCV(solver = 'newton-cg' , max_iter = 30 , cv = 10)
...
#LR1.fit(all_CV, all_labels_language)
#prediction3=LR1.predict(test_data)
...
rezultat.to_csv("./MNB_S11_alpha_0.3_cv-all.csv", index = False)
