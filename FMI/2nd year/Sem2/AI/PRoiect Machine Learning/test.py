...
CV = CountVectorizer(lowercase = False, stop_words = None,ngram_range=(1,7),token_pattern = '[a-zA-Z0-9$&+,:;=?@#|<>.^*()%!-]+')
...
#NB2 = MLPClassifier(hidden_layer_sizes=(150,100,50), max_iter=200,activation = 'relu',solver='adam',learning_rate_init=0.001)

NB2 = MultinomialNB(alpha = 0.3)
#NB2 = ComplementNB(alpha = 0.5)
#NB2 = svm.SVC()
#NB2 = GaussianNB()
...
#rezultat.to_csv("./MNB_S5-alpha-0.01-cv-all.csv", index = False)
